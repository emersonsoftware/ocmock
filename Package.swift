...
let package = Package(
    ...
    targets: [
        .target(name: "OCMock", dependencies: [], path: "Source", exclude: [], sources: ["OCMock"], publicHeadersPath: "OCMock", cSettings: [.unsafeFlags(["-fno-objc-arc"])], cxxSettings: nil, swiftSettings: nil, nil)]),
